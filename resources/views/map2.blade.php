...
<div class="hotel-search">
  ...
  <div id="locationField">
    <input id="aa" type="text" value="Bang sue"/>
  </div>
...
<!--
  ...
  -->
<script
        src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCCRomdTorifWxFpkw8ugK4a7xaZ0ZHGl0&callback=initMap&libraries=places&v=weekly"
        defer
></script>
...
<script>
  ...
  function initMap() {
    ...
    window.onload = (event) => {
      ...
      console.log('on load => ', document.getElementById("aa").value, document.getElementById("aa"))
      autocomplete = new google.maps.places.Autocomplete(
        document.getElementById("aa"),
        {
          // types: ["(cities)"],
  ...
  function onPlaceChanged() {
    ...
    if (place.geometry && place.geometry.location) {
      ...
      document.getElementById("aa").placeholder = "Bang sue";
    }
  }
